...
**As an optional challenge** Once we have a working pipeline for vehicle detection, add in our lane-finding algorithm from the last project to do simultaneous lane-finding and vehicle detection!
